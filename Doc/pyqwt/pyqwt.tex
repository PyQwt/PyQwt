...
\newcommand{\PyQwtShot}{\ulink{PyQwt-snapshot}{http://gerard.vermeulen.free.fr/index.html\#snapshot}}
...
\begin{enumerate}
  ...
  \item
    \PyQtExe
\end{enumerate}
Then, run \PyQwtExe{} or a \PyQwtShot{} and you are set.
Example programs and documentation for PyQwt and \Qwt{} are installed in the
folder \file{C:/Python22/PyQwt}.
...
The source packages \PyQwtTarGz{} or \PyQwtShot{} contain a CVS version of
the \Qwt{} library.
...
\begin{enumerate}
\item
  Unpack \PyQwtTarGz{} or \PyQwtShot{} and run
  \begin{verbatim}
cd PyQwt-3.6
  \end{verbatim}
  {}
...
\begin{enumerate}
\item
  Unpack \PyQwtZip{} or \PyQwtShot{} into for instance \file{C:/MyStuff} and
  run
  \begin{verbatim}
cd PyQwt-3.6
  \end{verbatim}
