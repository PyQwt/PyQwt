...
\end{verbatim}
  ...
  The commands build PyQwt against the included Qwt-4.2.0 library which is
  slightly patched and install PyQwt.
...
make install
\end{verbatim}
  Those commands build PyQwt against a system Qwt-4.2.0 library with its
  header files in \file{/usr/lib/qt3/include/qwt} and its library in 
  \file{/usr/lib/qt3/lib}.
\end{enumerate}

Contact the \mailinglist{}, if you run into problems.
FIXME: provide output of configure.py and make.
