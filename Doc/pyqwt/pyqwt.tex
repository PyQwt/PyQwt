...
\newcommand{\SipGpl}{\ulink{sip-x11-gpl-3.10.tar.gz}{http://pyqwt.sourceforge.net/support/sip-x11-gpl-3.10.tar.gz}}
...
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.9.tar.gz}{http://prdownloads.sourceforge.net/pyqwt/PyQwt-3.9.tar.gz?download}}
...
This documentation is for the future PyQwt-3.9. Check the \Download{}
...
\PyQwtTarGz{} should work with sip-3.9, sip-3.10, sip-4.0, PyQt-3.9-Commercial,
and PyQt-3.10-Commercial.  Install sip and PyQt with the new 'configure.py'
