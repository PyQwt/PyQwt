...
\newcommand{\NewSip}{\ulink{sip-4.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.1.tar.gz}}
\newcommand{\OldSip}{\ulink{sip-3.11.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-3.11.tar.gz}}
...
\newcommand{\Numeric}{\ulink{Numeric}
  {http://www.numpy.org}}
\newcommand{\NumericTarGz}{\ulink{Numeric-23.3.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/Numeric-23.3.tar.gz?download}}
...
\begin{enumerate}
  ...
  \item
    ...
    Supported versions: sip-4.1, -4.0.1, -4.0, -3.11, -3.10.2, -3.10.1, 
    and -3.10,
...
\begin{enumerate}
  ...
  \item
    \NewSip{}.\\
    Supported versions: sip-4.1, -4.0.1, and -4.0.
    You may also try a \snapshot{} at your own risk.
  \item
    \PyQtMac{}.\\
    Supported versions: PyQt-3.12, -3.11, and -3.10,
...
\begin{verbatim}
python setup.py run_sip --sip-file-dirs=../PyQt-x11-gpl-3.12/sip build
\end{verbatim}
