...
\newcommand{\NewSip}{\ulink{sip-4.0rc3.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.0.rc3.tar.gz}}
\newcommand{\OldSip}{\ulink{sip-3.10.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-3.10.1.tar.gz}}
\newcommand{\NewSipMac}{\ulink{sip-4.0rc3.tar.gz}
  {http://www.river-bank.demon.co.uk/download/sip/sip-4.0rc3.tar.gz}}
\newcommand{\SipNcZip}{\ulink{sip-win-nc-3.8.zip}
  {http://pyqwt.sourceforge.net/support/sip-win-nc-3.8.zip}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.11.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.11.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.11.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.11.tar.gz}}
...
\newcommand{\numarrayTarGz}{\ulink{numarray-0.9.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numarray-0.9.tar.gz?download}}
...
\newcommand{\PythonExe}{\ulink{Python-2.3.3.exe}
...
\newcommand{\numarrayExe}{\ulink{numarray-0.9.win32-py2.3.exe}
  {http://prdownloads.sourceforge.net/numpy/numarray-0.9.win32-py2.3.exe?download}}
\newcommand{\QtNcExe}{\ulink{QtWin230-NonCommercial.exe}
  {ftp://ftp.trolltech.com/qt/non-commercial/QtWin230-NonCommercial.exe}}
\newcommand{\PyQtExe}{\ulink{PyQt-win-nc-3.8.exe}
  {http://pyqwt.sourceforge.net/download/PyQt-win-nc-3.8.exe}}
\newcommand{\PyQwtExe}{\ulink{PyQwt\_Qt230-3.8.win32-py2.3.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt\_Qt230-3.8.win32-py2.3.exe?download}}
...
You can install PyQwt on the \POSIX{} (Unix, Linux), Mac OS X,
and Microsoft Windows operating systems:
\begin{enumerate}
  \item
    see \ref{prerequisites} for the required software packages needed 
  ...
  \item
    ...
    Windows installer, to be used with the old non-commercial releases of
    Qt and PyQt.
\end{enumerate}
...
\begin{enumerate}
  \item
    ...
    Supported versions: Python-2.3.x, Python-2.2.x, and probably
    also Python-2.1.x.
  \item
  ...
  \item
    ...
    Supported versions: sip-4.0, -3.10.1, and -3.10, but the most
    recent version gets most testing.
    You may also try a \snapshot{} at your own risk.
  \item
    \PyQtGpl{}.\\
    Supported versions: PyQt-3.11, and -3.10, but the most recent
...
\subsection{Build prerequisites for PyQwt on Mac OS X}

\Future{}

Build prerequisites for \PyQwtTarGz{} on Mac OS X are:
\begin{enumerate}
  \item
    \ulink{Python}{http://www.python.org}.\\
...
\begin{notice}[warning]
A bug in the configuration module of PyQt-3.9 makes it impossible to use 
the \file{configure.py} script of PyQwt.
\end{notice}

\begin{enumerate}
\item
  Unpack \PyQwtTarGz{} and read \ReadMePatches{} to check for patches.
\item
