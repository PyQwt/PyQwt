...
% Source code
\newcommand{\SipGpl}{\ulink{sip-x11-gpl-3.6.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/sip-x11-gpl-3.6.tar.gz}}
\newcommand{\SipNcZip}{\ulink{sip-win-nc-3.6.zip}{http://www.river-bank.demon.co.uk/download/PyQt/sip-win-nc-3.6.zip}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.6.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-x11-gpl-3.6.tar.gz}}
\newcommand{\PyQtNcZip}{\ulink{PyQt-win-nc-3.6.zip}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.6.zip.gz}}
\newcommand{\snapshot}{\ulink{snapshot}{http://www.river-bank.demon.co.uk/download/snapshots}}
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.6.tar.gz}{http://gerard.vermeulen.free.fr/PQwt-3.6.tar.gz}}
\newcommand{\PyQwtTarBz}{\ulink{PyQwt-3.6.tar.bz2}{http://gerard.vermeulen.free.fr/PQwt-3.6.tar.bz2}}
\newcommand{\PyQwtZip}{\ulink{PyQwt-3.6.zip}{http://gerard.vermeulen.free.fr/PyQwt-3.6.zip}}

% Installers for MS-Windows
\newcommand{\PythonExe}{\ulink{Python-2.2.2.exe}{http://www.python.org/ftp/python/2.2.2/Python-2.2.2.exe}}
\newcommand{\NumericExe}{\ulink{Numeric-23.0.win32-py2.2.exe}{http://gerard.vermeulen.free.fr/support/Numeric-23.0.win32-py2.2.exe}}
\newcommand{\QtNcExe}{\ulink{QtWin230-NonCommercial.exe}{ftp://ftp.trolltech.com/qt/non-commercial/QtWin230-NonCommercial.exe}}
\newcommand{\PyQtExe}{\ulink{PyQt-win-nc-3.6.exe}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.6.exe}}
\newcommand{\PyQtEduExe}{\ulink{PyQt-win-edu-msvc-3.6.exe}{http://www.riverbankcomputing.co.uk/download/PyQt-win-edu-msvc-3.6.exe}}
\newcommand{\PyQwtExe}{\ulink{PyQwt\_Qt230-3.6.win32-py2.2.exe}{http://gerard.vermeulen.free.fr/PyQwt\_Qt230-3.6.win32-py2.2.exe}}
...
Qwt is library based on the Qt GUI library from Troll Tech AS.
The Qwt library contains widgets and components useful for technical and
scientific purposes.
...
\begin{enumerate}
  ...
  \item
    \PyQtExe
\end{enumerate}
Then, run \PyQwtExe{} and you are set.  Example programs and documentation
for PyQwt and \Qwt{} are installed in the folder \file{C:/Python22/PyQwt}.
...
\begin{enumerate}
  ...
  \item
    ...
    I am using Qt-3.1.x, Qt-3.0.x, Qt-2.3.1 and Qt-2.3.0.
    Earlier versions of Qt are not supported.
  \item
    \SipGpl{}, sip-x11-gpl-3.5.tar.gz, sip-x11-3.4.tar.gz or
    at your own risk a \snapshot.
  \item
    \PyQtGpl{}, PyQt-x11-gpl-3.5.tar.gz, PyQt-x11-3.4.tar.gz or
    at your own risk a \snapshot.
\end{enumerate}
...
I am using Numeric-23.0 and Numeric-22.0, but Numeric-21.x should also
work. Earlier versions Numeric are not supported.


The source packages \PyQwtTarGz{} or \PyQwtTarBz{} contain a CVS version of
the \Qwt{} library.

\begin{notice}[note]
In general, the version numbers of sip\&PyQt have to match (except
for snapshots).
\end{notice}
...
\begin{enumerate}
\item
  Unpack \PyQwtTarGz{} or \PyQwtTarBz{} and run
  \begin{verbatim}
cd PyQwt-3.6
  \end{verbatim}
  {}
...
python setup.py command --options
  ...
  \begin{verbatim}
python setup.py run_sip --sip-file-dirs=../PyQt-x11-gpl-3.6/sip build
  \end{verbatim}
...
\begin{enumerate}
  \item
    If you are going to use PyQt-win-nc-3.6 (tested) or PyQt-win-edu-3.6
  ...
  \item
    If you have installed PyQt\&sip-3.6-Commercial and did not delete the
...
\begin{notice}[note]
The build procedures for the PyQt\&sip-Commercial and PyQt\&sip-Educational
are very similar to the build procedure of PyQt\&sip-NonCommercial.
Of course, you should have installed Qt-Commercial or Qt-Educational and you
have to start from the appropiate zip files in the procedure below.
\end{notice}
...
\begin{notice}[warning]
  ...
  files that are not part of PyQt-win-nc-3.6.
\end{notice}
...
\begin{enumerate}
\item
  Unpack \PyQwtZip{} into for instance \file{C:/MyStuff} and run
  \begin{verbatim}
cd PyQwt-3.6
  \end{verbatim}
  {}
