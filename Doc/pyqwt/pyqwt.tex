...
\newcommand{\PythonExeBC}{\ulink{Python-2.3.2-1.exe}{http://www.python.org/ftp/python/2.3.2/Python-2.3.2-1.exe}}
...
\begin{notice}[note]
  The \Qwt{} has a designer plugin that works with Qt-3.x.x.  If you want
  to use the plugin, you must install the original \Qwt{} library or the
  slightly modified version that is included in \PyQwtTarGz{}.
\end{notice}
