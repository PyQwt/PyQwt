...
\newcommand{\numarrayTarGz}{\ulink{numarray-0.8.tar.gz}{http://prdownloads.sourceforge.net/numpy/numarray-0.8.tar.gz?download}}
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.10.tar.gz}{http://prdownloads.sourceforge.net/pyqwt/PyQwt-3.10.tar.gz?download}}
...
\newcommand{\NumArrayExe}{\ulink{numarray-0.8.win32-py2.3.exe}{http://prdownloads.sourceforge.net/numpy/numarray-0.7.win32-py2.3.exe?download}}
...
This documentation is for the future PyQwt-3.10. Check the \Download{}
page for the latest releases.
\end{notice}
}
\newcommand{\NonCommercial}{
\begin{notice}[note]
\PyQwtExe{} is the latest ``non-commercial'' version of PyQwt on Window for
...
\begin{enumerate}
  ...
  \item
    ...
    installation scripts have been adapted to Qt-3.0.x, Qt-3.1.x and Qt-3.2.x.
...
\begin{enumerate}
  ...
  \item
    ...
    \PyQwtTarGz{} is compatible with Qt-3.2.x, Qt-3.1.x, Qt-3.0.x, Qt-2.3.1 and
    Qt-2.3.0.
    Earlier versions of Qt are not supported.
  \item
    \SipGpl{}.\\
    \PyQwtTarGz{} is compatible with sip-4.0, -3.10, and -3.9, but the most
    recent version gets most testing.
    You may also try a \snapshot{} at your own risk.
  \item
    \PyQtGpl{}.\\
    \PyQwtTarGz{} is compatible with PyQt-3.10 and -3.9, but the most recent
...
\begin{notice}[warning]
  Most bug reports are related to the presence of
