...
\newcommand{\PyQtExe}{\ulink{PyQt-win-nc-msvc-3.12.exe}
  {http://pyqwt.sourceforge.net/download/PyQt-win-nc-msvc-3.12.exe}}
\newcommand{\PyQwtExe}{\ulink{PyQwt\_Qt230-4.0.win32-py2.3.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt\_Qt230-4.0.win32-py2.3.exe?download}}
...
around this limitation.  Get PyQwt-3.8 from the \Download{} page,
if you must stick to Windows-98.
\end{notice}
