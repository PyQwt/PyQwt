...
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.8.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-x11-gpl-3.8.tar.gz}}
...
\newcommand{\numarrayTarGz}{\ulink{numarray-0.6.tar.gz}{http://prdownloads.sourceforge.net/numpy/numarray-0.6.tar.gz?download}}
...
\newcommand{\PythonExe}{\ulink{Python-2.3.exe}{http://www.python.org/ftp/python/2.3/Python-2.3.exe}}
\newcommand{\NumericExe}{\ulink{Numeric-23.0.win32-py2.3.exe}{http://prdownloads.sourceforge.net/numpy/Numeric-23.0.win32-py2.3.exe?download}}
\newcommand{\QtNcExe}{\ulink{QtWin230-NonCommercial.exe}{ftp://ftp.trolltech.com/qt/non-commercial/QtWin230-NonCommercial.exe}}
\newcommand{\PyQtExe}{\ulink{PyQt-win-nc-3.8.exe}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.8.exe}}
\newcommand{\PyQtEduExe}{\ulink{PyQt-win-edu-msvc-3.8.exe}{http://www.riverbankcomputing.co.uk/download/PyQt-win-edu-msvc-3.8.exe}}
...
\begin{enumerate}
  ...
  \item
    ...
    I am using Qt-3.2.0, Qt-3.1.x, Qt-3.0.x, Qt-2.3.1 and Qt-2.3.0.
    Earlier versions of Qt are not supported.
  \item
    \SipGpl{},
    sip-x11-gpl-3.7.tar.gz,
    sip-x11-gpl-3.6.tar.gz,
    sip-x11-gpl-3.5.tar.gz,
    sip-x11-3.4.tar.gz
    or at your own risk a \snapshot.
  \item
    \PyQtGpl{},
    PyQt-x11-gpl-3.7.tar.gz,
    PyQt-x11-gpl-3.6.tar.gz,
...
Numeric-22.0, and Numeric-21.x should also work, but earlier versions Numeric
are not supported.
If you want to try Numarray, get the latest!
