...
\newcommand{\NewSip}{\ulink{sip-4.0rc4.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.0.rc4.tar.gz}}
...
\begin{enumerate}
  ...
  \item
    ...
    Supported versions: sip-4.0, -3.10.2, -3.10.1, and -3.10, but the most
