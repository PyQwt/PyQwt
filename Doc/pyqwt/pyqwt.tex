...
\newcommand{\PrerequisitesEnd}{
  The source package \PyQwtTarGz{} contains the \Qwt-4.2.0 library with a few
  patches.
  However, you can also build PyQwt against the official \Qwt-4.2.0 library
  (not the 4.2.0rcX release candidates because of API enhancements).
