...
% Source code
\newcommand{\SipGpl}{\ulink{sip-x11-gpl-3.7.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/sip-x11-gpl-3.7.tar.gz}}
\newcommand{\SipNcZip}{\ulink{sip-win-nc-3.7.zip}{http://www.river-bank.demon.co.uk/download/PyQt/sip-win-nc-3.7.zip}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.7.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-x11-gpl-3.7.tar.gz}}
\newcommand{\PyQtNcZip}{\ulink{PyQt-win-nc-3.7.zip}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.7.zip.gz}}
\newcommand{\snapshot}{\ulink{snapshot}{http://www.river-bank.demon.co.uk/download/snapshots}}
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.7.tar.gz}{http://sourceforge.net/projects/pyqwt/PyQwt-3.7.tar.gz}}
\newcommand{\PyQwtShot}{\ulink{PyQwt-snapshot}{http://gerard.vermeulen.free.fr/index.html\#snapshot}}

% Installers for MS-Windows
\newcommand{\PythonExe}{\ulink{Python-2.2.3.exe}{http://www.python.org/ftp/python/2.2.2/Python-2.2.3.exe}}
...
\newcommand{\PyQwtExe}{\ulink{PyQwt\_Qt230-3.7.win32-py2.2.exe}{http://sourceforge.net/projects/pyqwt/PyQwt\_Qt230-3.7.win32-py2.2.exe}}
