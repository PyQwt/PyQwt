...
% Source code
\newcommand{\SipGpl}{\ulink{sip-x11-gpl-3.7.tar.gz}{http://www.river-bank.demon.co.uk/download/sip/sip-x11-gpl-3.7.tar.gz}}
\newcommand{\SipNcZip}{\ulink{sip-win-nc-3.7.zip}{http://www.river-bank.demon.co.uk/download/sip/sip-win-nc-3.7.zip}}
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.7.tar.gz}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-x11-gpl-3.7.tar.gz}}
\newcommand{\PyQtNcZip}{\ulink{PyQt-win-nc-3.7.zip}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.7.zip}}
\newcommand{\snapshot}{\ulink{snapshot}{http://www.river-bank.demon.co.uk/download/snapshots}}
\newcommand{\NumericTarGz}{\ulink{Numeric-23.0.tar.gz}{http://prdownloads.sourceforge.net/numpy/Numeric-23.0.tar.gz?download}}
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.7.tar.gz}{http://prdownloads.sourceforge.net/pyqwt/PyQwt-3.7.tar.gz?download}}
\newcommand{\PyQwtShot}{\ulink{PyQwt-snapshot}{http://gerard.vermeulen.free.fr/index.html\#snapshot}}

% Installers for MS-Windows
\newcommand{\PythonExe}{\ulink{Python-2.2.3.exe}{http://www.python.org/ftp/python/2.2.3/Python-2.2.3.exe}}
\newcommand{\NumericExe}{\ulink{Numeric-23.0.win32-py2.2.exe}{http://prdownloads.sourceforge.net/numpy/Numeric-23.0.win32-py2.2.exe?download}}
\newcommand{\QtNcExe}{\ulink{QtWin230-NonCommercial.exe}{ftp://ftp.trolltech.com/qt/non-commercial/QtWin230-NonCommercial.exe}}
\newcommand{\PyQtExe}{\ulink{PyQt-win-nc-3.7.exe}{http://www.river-bank.demon.co.uk/download/PyQt/PyQt-win-nc-3.7.exe}}
\newcommand{\PyQtEduExe}{\ulink{PyQt-win-edu-msvc-3.7.exe}{http://www.riverbankcomputing.co.uk/download/PyQt-win-edu-msvc-3.7.exe}}
\newcommand{\PyQwtExe}{\ulink{PyQwt\_Qt230-3.7.win32-py2.2.exe}{http://prdownloads.sourceforge.net/pyqwt/PyQwt\_Qt230-3.7.win32-py2.2.exe?download}}
...
\begin{enumerate}
  ...
  \item
    \SipGpl{}, sip-x11-gpl-3.6.tar.gz, sip-x11-gpl-3.5.tar.gz,
    sip-x11-3.4.tar.gz or at your own risk a \snapshot.
  \item
    \PyQtGpl{}, PyQt-x11-gpl-3.6.tar.gz, PyQt-x11-gpl-3.5.tar.gz,
    PyQt-x11-3.4.tar.gz or at your own risk a \snapshot.
\end{enumerate}
...
I am using \NumericTarGz{} and Numeric-22.0, but Numeric-21.x should also
...
python setup.py command --options
  ...
  \begin{verbatim}
python setup.py run_sip --sip-file-dirs=../PyQt-x11-gpl-3.7/sip build
  \end{verbatim}
...
\begin{enumerate}
  \item
    If you are going to use PyQt-win-nc-3.7 (tested) or PyQt-win-edu-3.7
  ...
  \item
    If you have installed PyQt\&sip-3.7-Commercial and did not delete the
...
\begin{notice}[warning]
  ...
  files that are not part of PyQt-win-nc-3.7.
\end{notice}
...
\begin{enumerate}
\item
  Unpack \PyQwtTarGz{} or \PyQwtShot{} into for instance \file{C:/MyStuff} and
  run
  \begin{verbatim}
cd PyQwt-3.7
  \end{verbatim}
