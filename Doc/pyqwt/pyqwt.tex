...
% Links
\newcommand{\me}{\ulink{me}{mailto:pyqwt-users@lists.sourceforge.net}}
...
This documentation is for the future PyQwt-3.8rc0. Check the \Download{}
...
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-3.8rc0.tar.gz}{http://prdownloads.sourceforge.net/pyqwt/PyQwt-3.8.tar.gz?download}}
...
\newcommand{\PyQwtExeBC}{\ulink{PyQwt\_Qt230-3.8rc0.win32-py2.3.exe}{http://prdownloads.sourceforge.net/pyqwt/PyQwt\_Qt230-3.8rc0.win32-py2.3.exe?download}}
...
plotting of lists, tuples and powerful array types provided by the Python
...
\section{The Python Extension modules \label{numeric-intro}}
...
This section addresses the CLI facilities and functions to convert 
\class{QImage} instances to Numeric and numarray arrays and vice versa.
...
\begin{enumerate}
  ...
  \item
    \SipGpl{}.
    I support sip-3.8, -3.7 and -3.6, but the most recent version
    gets most testing. You may also try a \snapshot{} at your own risk.
  \item
    \PyQtGpl{}.
    I support PyQt-3.8.1, -3.8, -3.7 and -3.6, but the most recent version
    gets most testing. You may also try a \snapshot{} at your own risk.
  \item
...
The source package \PyQwtTarGz{} contains version 4.2.0rc1 of the \Qwt{}
library.
